...
namespace DoozyUI
{
    ...
    public class DUIUpgradeManager
    {
        ...
        {
            string oldDatabasePath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Data/";
            if (QuickEngine.IO.File.Exists(oldDatabasePath + "DoozyUI_Data.asset"))
            {
                ...
                if (oldDatabase.elementSounds != null && oldDatabase.elementSounds.Count > 0)
                {
                    for (int i = 0; i < oldDatabase.elementSounds.Count; i++)
                    {
                        ...
                        if (DUI.UISoundNameExists(oldDatabase.elementSounds[i].soundName, SoundType.UIElements)) { continue; }
                ...
                if (oldDatabase.buttonSounds != null && oldDatabase.buttonSounds.Count > 0)
                {
                    for (int i = 0; i < oldDatabase.buttonSounds.Count; i++)
                    {
                        ...
                        if (DUI.UISoundNameExists(oldDatabase.buttonSounds[i].onClickSound, SoundType.UIButtons)) { continue; }
        ...
        public static void CleanFiles()
        {
            ...
            string presetsFolderPath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Presets/";
            ...
            //Deleting obsolete classes /Scripts/Editor/
            string editorFilesPath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Scripts/Editor/";
            ...
            string playmakerInspectorFilePath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/PlayMaker/Scripts/Editor/PlaymakerEventDispatcherInspector.cs";
            ...
            string helpersFilesPath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Scripts/Helpers/";
            ...
            //Deleting old images
            string imagesFilePath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Images/";
        ...
        public static void DeleteExamples()
        {
            ...
            FileUtil.DeleteFileOrDirectory(QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/_EXAMPLES");
            AssetDatabase.Refresh();
            EditorUtility.ClearProgressBar();
