...
namespace DoozyUI
{
    ...
    public class UITrigger : MonoBehaviour
    {
        ...
        {
            GameObject go = new GameObject("New UITrigger", typeof(UITrigger));
        ...
        /// <summary>
        /// If triggerOnGameEvent is true, this is the game event value that will make this UITrigger extcute its actions.
        /// </summary>
        ...
        /// <summary>
        /// If any of triggerOnButtonClick or triggerOnButtonDoubleClick or triggerOnButtonLongClick are true, this is the button name value that will make this UITrigger extcute its actions.
        /// </summary>
        ...
        /// <summary>
        /// Retruns true if this UITrigger has proper settings set up and is operational.
        /// </summary>
        public bool Enabled
        {
            get
