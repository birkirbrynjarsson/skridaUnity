...
namespace DoozyUI
{
    ...
    public partial class DUI
    {
        ...
        public static string RELATIVE_PATH_UIELEMENTS { get { return QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Resources/" + RESOURCES_PATH_UIELEMENTS; } }
        public static string RELATIVE_PATH_UIBUTTONS { get { return QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Resources/" + RESOURCES_PATH_UIBUTTONS; } }
        public static string RELATIVE_PATH_UISOUNDS { get { return QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Resources/" + RESOURCES_PATH_UISOUNDS; } }
        public static string RELATIVE_PATH_CANVAS_DATABASE { get { return QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Resources/" + RESOURCES_PATH_CANVAS_DATABASE; } }
        public static string RELATIVE_PATH_SETTINGS { get { return QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Resources/" + RESOURCES_PATH_SETTINGS; } }
        ...
        public static void RefreshUIElementsDatabase()
        {
            ...
            string[] fileNames = GetUIElementCategoriesFileNames;
        ...
        public static void RefreshUIButtonsDatabase()
        {
            ...
            string[] fileNames = GetUIButtonCategoriesFileNames;
            for (int fileIndex = 0; fileIndex < fileNames.Length; fileIndex++)
            {
