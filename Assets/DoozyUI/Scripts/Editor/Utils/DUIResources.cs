...
namespace DoozyUI
{
    public partial class DUIResources
    {
        ...
        public static Font Sansation { get { if (m_Sansation == null) { m_Sansation = AssetDatabase.LoadAssetAtPath<Font>(QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Fonts/" + "Sansation-Regular.ttf"); } return m_Sansation; } }

        private static string m_ImagesPath;
        public static string ImagesPath { get { if (string.IsNullOrEmpty(m_ImagesPath)) { m_ImagesPath = QuickEngine.IO.File.GetRelativeDirectoryPath("DoozyUI") + "/Images/"; } return m_ImagesPath; } }
